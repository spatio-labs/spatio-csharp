...
namespace Spatio.Sdk.Model
{
    ...
    public partial class UserInfoResponse : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="UserInfoResponse" /> class.
        /// </summary>
        /// <param name="sub">User identifier (stable for the lifetime of the user). (required).</param>
        ...
        public UserInfoResponse(string sub = default, string email = default, bool emailVerified = default, string name = default, string givenName = default, string familyName = default, string preferredUsername = default, string picture = default, int updatedAt = default)
        {
            // to ensure "sub" is required (not null)
            if (sub == null)
            {
                throw new ArgumentNullException("sub is a required property for UserInfoResponse and cannot be null");
            }
            this.Sub = sub;
            this.Email = email;
        ...
        /// </summary>
        /// <value>User identifier (stable for the lifetime of the user).</value>
