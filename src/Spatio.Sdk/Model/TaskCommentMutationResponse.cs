...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TaskCommentMutationResponse")]
    public partial class TaskCommentMutationResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TaskCommentMutationResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TaskCommentMutationResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TaskCommentMutationResponse" /> class.
        /// </summary>
        /// <param name="comment">comment (required).</param>
        /// <param name="success">success (required).</param>
        public TaskCommentMutationResponse(TaskComment comment = default, bool success = default)
        {
            // to ensure "comment" is required (not null)
            if (comment == null)
            {
                throw new ArgumentNullException("comment is a required property for TaskCommentMutationResponse and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TaskCommentMutationResponse {\n");
