...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CalendarProvidersInfo")]
    public partial class CalendarProvidersInfo : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CalendarProvidersInfo" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CalendarProvidersInfo() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CalendarProvidersInfo" /> class.
        /// </summary>
        /// <param name="providers">providers (required).</param>
        public CalendarProvidersInfo(List<CalendarProviderInfo> providers = default)
        {
            // to ensure "providers" is required (not null)
            if (providers == null)
            {
                throw new ArgumentNullException("providers is a required property for CalendarProvidersInfo and cannot be null");
            }
        ...
        public List<CalendarProviderInfo> Providers { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CalendarProvidersInfo {\n");
