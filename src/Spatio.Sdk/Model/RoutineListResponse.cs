...
namespace Spatio.Sdk.Model
{
    ...
    /// RoutineListResponse
    /// </summary>
    [DataContract(Name = "RoutineListResponse")]
    public partial class RoutineListResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RoutineListResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RoutineListResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RoutineListResponse" /> class.
        /// </summary>
        /// <param name="items">items (required).</param>
        public RoutineListResponse(List<Routine> items = default)
        {
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new ArgumentNullException("items is a required property for RoutineListResponse and cannot be null");
            }
            this.Items = items;
        }
        ...
        public List<Routine> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RoutineListResponse {\n");
