...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CommitChunkedUploadRequest")]
    public partial class CommitChunkedUploadRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CommitChunkedUploadRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CommitChunkedUploadRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CommitChunkedUploadRequest" /> class.
        /// </summary>
        /// <param name="sessionId">sessionId (required).</param>
        public CommitChunkedUploadRequest(string sessionId = default)
        {
            // to ensure "sessionId" is required (not null)
            if (sessionId == null)
            {
                throw new ArgumentNullException("sessionId is a required property for CommitChunkedUploadRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CommitChunkedUploadRequest {\n");
