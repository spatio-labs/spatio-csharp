...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateChannelRequest")]
    public partial class CreateChannelRequest : IValidatableObject
    {
        ...
        public CreateChannelRequest(string accountId = default, string name = default, string description = default, bool isPrivate = default)
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CreateChannelRequest and cannot be null");
            }
            this.Name = name;
