...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CommentResponse")]
    public partial class CommentResponse : IValidatableObject
    {
        /// <summary>
        ...
        public CommentResponse(Comment comment = default)
        {
            // to ensure "comment" is required (not null)
            if (comment == null)
            {
                throw new ArgumentNullException("comment is a required property for CommentResponse and cannot be null");
            }
