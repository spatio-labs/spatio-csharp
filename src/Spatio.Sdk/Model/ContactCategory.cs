...
namespace Spatio.Sdk.Model
{
    ...
    /// ContactCategory
    /// </summary>
    [DataContract(Name = "ContactCategory")]
    public partial class ContactCategory : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactCategory" /> class.
        /// </summary>
        ...
        public ContactCategory(string id = default, string name = default, string color = default, string description = default, string organizationId = default)
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for ContactCategory and cannot be null");
            }
            this.Id = id;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for ContactCategory and cannot be null");
            }
            this.Name = name;
            this.Color = color;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContactCategory {\n");
