...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OrganizationMemberListResponse")]
    public partial class OrganizationMemberListResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrganizationMemberListResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OrganizationMemberListResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OrganizationMemberListResponse" /> class.
        /// </summary>
        /// <param name="members">members (required).</param>
        /// <param name="total">total (required).</param>
        public OrganizationMemberListResponse(List<OrganizationMember> members = default, int total = default)
        {
            // to ensure "members" is required (not null)
            if (members == null)
            {
                throw new ArgumentNullException("members is a required property for OrganizationMemberListResponse and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OrganizationMemberListResponse {\n");
