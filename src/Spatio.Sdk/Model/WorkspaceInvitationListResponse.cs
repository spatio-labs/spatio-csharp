...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WorkspaceInvitationListResponse")]
    public partial class WorkspaceInvitationListResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkspaceInvitationListResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WorkspaceInvitationListResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkspaceInvitationListResponse" /> class.
        /// </summary>
        /// <param name="invitations">invitations (required).</param>
        public WorkspaceInvitationListResponse(List<WorkspaceInvitation> invitations = default)
        {
            // to ensure "invitations" is required (not null)
            if (invitations == null)
            {
                throw new ArgumentNullException("invitations is a required property for WorkspaceInvitationListResponse and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WorkspaceInvitationListResponse {\n");
