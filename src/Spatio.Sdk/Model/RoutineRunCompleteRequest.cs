...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RoutineRunCompleteRequest")]
    public partial class RoutineRunCompleteRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RoutineRunCompleteRequest" /> class.
        /// </summary>
        /// <param name="status">status.</param>
        /// <param name="metadata">metadata.</param>
        public RoutineRunCompleteRequest(string status = default, Dictionary<string, Object> metadata = default)
        {
            this.Status = status;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RoutineRunCompleteRequest {\n");
