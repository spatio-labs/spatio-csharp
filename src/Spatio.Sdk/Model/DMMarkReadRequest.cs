...
namespace Spatio.Sdk.Model
{
    ...
    /// DMMarkReadRequest
    /// </summary>
    [DataContract(Name = "DMMarkReadRequest")]
    public partial class DMMarkReadRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DMMarkReadRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DMMarkReadRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DMMarkReadRequest" /> class.
        /// </summary>
        /// <param name="messageId">messageId (required).</param>
        /// <param name="accountId">accountId.</param>
        public DMMarkReadRequest(string messageId = default, string accountId = default)
        {
            // to ensure "messageId" is required (not null)
            if (messageId == null)
            {
                throw new ArgumentNullException("messageId is a required property for DMMarkReadRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DMMarkReadRequest {\n");
