...
namespace Spatio.Sdk.Model
{
    ...
    /// WriteAppFileRequest
    /// </summary>
    [DataContract(Name = "WriteAppFileRequest")]
    public partial class WriteAppFileRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WriteAppFileRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WriteAppFileRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WriteAppFileRequest" /> class.
        /// </summary>
        /// <param name="path">path (required).</param>
        /// <param name="content">content (required).</param>
        public WriteAppFileRequest(string path = default, string content = default)
        {
            // to ensure "path" is required (not null)
            if (path == null)
            {
                throw new ArgumentNullException("path is a required property for WriteAppFileRequest and cannot be null");
            }
            this.Path = path;
            // to ensure "content" is required (not null)
            if (content == null)
            {
                throw new ArgumentNullException("content is a required property for WriteAppFileRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WriteAppFileRequest {\n");
