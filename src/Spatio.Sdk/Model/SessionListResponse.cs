...
namespace Spatio.Sdk.Model
{
    ...
    public partial class SessionListResponse : IValidatableObject
    {
        /// <summary>
        ...
        public SessionListResponse(List<Session> sessions = default)
        {
            // to ensure "sessions" is required (not null)
            if (sessions == null)
            {
                throw new ArgumentNullException("sessions is a required property for SessionListResponse and cannot be null");
            }
