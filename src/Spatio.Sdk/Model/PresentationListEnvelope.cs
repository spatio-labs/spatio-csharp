...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PresentationListEnvelope")]
    public partial class PresentationListEnvelope : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PresentationListEnvelope" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PresentationListEnvelope() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PresentationListEnvelope" /> class.
        /// </summary>
        /// <param name="items">items (required).</param>
        /// <param name="accounts">accounts (required).</param>
        public PresentationListEnvelope(List<Presentation> items = default, List<AccountStatus> accounts = default)
        {
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new ArgumentNullException("items is a required property for PresentationListEnvelope and cannot be null");
            }
            this.Items = items;
            // to ensure "accounts" is required (not null)
            if (accounts == null)
            {
                throw new ArgumentNullException("accounts is a required property for PresentationListEnvelope and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PresentationListEnvelope {\n");
