...
namespace Spatio.Sdk.Model
{
    ...
    public partial class CreateContactRequest : IValidatableObject
    {
        ...
        public CreateContactRequest(string firstName = default, string lastName = default, string email = default, string phone = default, string company = default, string title = default, string notes = default, Dictionary<string, Object> metadata = default)
        {
