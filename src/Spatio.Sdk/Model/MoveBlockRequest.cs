...
namespace Spatio.Sdk.Model
{
    ...
    /// MoveBlockRequest
    /// </summary>
    [DataContract(Name = "MoveBlockRequest")]
    public partial class MoveBlockRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MoveBlockRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MoveBlockRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MoveBlockRequest" /> class.
        /// </summary>
        /// <param name="parentId">New parent block id; omit to keep the current parent..</param>
        /// <param name="position">position (required).</param>
        public MoveBlockRequest(string parentId = default, int position = default)
        {
        ...
        /// </summary>
        /// <value>New parent block id; omit to keep the current parent.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MoveBlockRequest {\n");
