...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ExportPDFRequest")]
    public partial class ExportPDFRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExportPDFRequest" /> class.
        /// </summary>
        /// <param name="rasterizedSlides">rasterizedSlides.</param>
        /// <param name="theme">Optional palette override. Schemaless — the export sidecar accepts a free-form palette object. Treat as opaque. .</param>
        public ExportPDFRequest(List<ExportPDFRequestRasterizedSlidesInner> rasterizedSlides = default, Dictionary<string, Object> theme = default)
        {
            this.RasterizedSlides = rasterizedSlides;
            this.Theme = theme;
        }

        /// <summary>
        /// Gets or Sets RasterizedSlides
        /// </summary>
        [DataMember(Name = "rasterizedSlides", EmitDefaultValue = false)]
        public List<ExportPDFRequestRasterizedSlidesInner> RasterizedSlides { get; set; }

        /// <summary>
        /// Optional palette override. Schemaless — the export sidecar accepts a free-form palette object. Treat as opaque. 
        /// </summary>
        /// <value>Optional palette override. Schemaless — the export sidecar accepts a free-form palette object. Treat as opaque. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExportPDFRequest {\n");
            sb.Append("  RasterizedSlides: ").Append(RasterizedSlides).Append("\n");
