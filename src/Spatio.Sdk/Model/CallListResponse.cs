...
namespace Spatio.Sdk.Model
{
    ...
    /// CallListResponse
    /// </summary>
    [DataContract(Name = "CallListResponse")]
    public partial class CallListResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CallListResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CallListResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CallListResponse" /> class.
        /// </summary>
        /// <param name="calls">calls (required).</param>
        /// <param name="total">total.</param>
        public CallListResponse(List<SpatioCall> calls = default, int total = default)
        {
            // to ensure "calls" is required (not null)
            if (calls == null)
            {
                throw new ArgumentNullException("calls is a required property for CallListResponse and cannot be null");
            }
            this.Calls = calls;
            this.Total = total;
        }
        ...
        public List<SpatioCall> Calls { get; set; }
