...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EmailFolderListResponse")]
    public partial class EmailFolderListResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailFolderListResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EmailFolderListResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailFolderListResponse" /> class.
        /// </summary>
        /// <param name="folders">folders (required).</param>
        public EmailFolderListResponse(List<EmailFolder> folders = default)
        {
            // to ensure "folders" is required (not null)
            if (folders == null)
            {
                throw new ArgumentNullException("folders is a required property for EmailFolderListResponse and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EmailFolderListResponse {\n");
