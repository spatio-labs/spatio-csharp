...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DMMessageEnvelope")]
    public partial class DMMessageEnvelope : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DMMessageEnvelope" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DMMessageEnvelope() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DMMessageEnvelope" /> class.
        /// </summary>
        /// <param name="message">message (required).</param>
        public DMMessageEnvelope(ChatMessage message = default)
        {
            // to ensure "message" is required (not null)
            if (message == null)
            {
                throw new ArgumentNullException("message is a required property for DMMessageEnvelope and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DMMessageEnvelope {\n");
