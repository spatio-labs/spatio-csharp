...
namespace Spatio.Sdk.Model
{
    ...
    /// CreateLabelRequest
    /// </summary>
    [DataContract(Name = "CreateLabelRequest")]
    public partial class CreateLabelRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateLabelRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateLabelRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateLabelRequest" /> class.
        /// </summary>
        ...
        public CreateLabelRequest(string accountId = default, string name = default, string messageListVisibility = default, string labelListVisibility = default, LabelColor color = default)
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CreateLabelRequest and cannot be null");
            }
            this.Name = name;
