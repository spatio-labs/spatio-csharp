...
namespace Spatio.Sdk.Model
{
    ...
    public partial class Contact : IValidatableObject
    {
        ...
        public Contact(string id = default, string userId = default, string organizationId = default, string firstName = default, string lastName = default, string email = default, string phone = default, string company = default, string title = default, string notes = default, string scope = default, string provider = default, Dictionary<string, Object> metadata = default, DateTime createdAt = default, DateTime updatedAt = default)
        {
