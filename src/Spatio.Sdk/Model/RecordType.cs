...
namespace Spatio.Sdk.Model
{
    ...
    public partial class RecordType : IValidatableObject
    {
        /// <summary>
        ...
        public RecordType(string id = default, string organizationId = default, string slug = default, string name = default, string namePlural = default, string icon = default, List<Dictionary<string, Object>> attributeSchema = default, DateTime createdAt = default, DateTime updatedAt = default)
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for RecordType and cannot be null");
            }
            this.Id = id;
            // to ensure "organizationId" is required (not null)
            if (organizationId == null)
            {
                throw new ArgumentNullException("organizationId is a required property for RecordType and cannot be null");
            }
