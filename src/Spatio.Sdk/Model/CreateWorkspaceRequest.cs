...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateWorkspaceRequest")]
    public partial class CreateWorkspaceRequest : IValidatableObject
    {
        ...
        protected CreateWorkspaceRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateWorkspaceRequest" /> class.
        /// </summary>
        ...
        public CreateWorkspaceRequest(string name = default, string slug = default, string description = default, string organizationId = default)
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CreateWorkspaceRequest and cannot be null");
            }
            this.Name = name;
            this.Slug = slug;
