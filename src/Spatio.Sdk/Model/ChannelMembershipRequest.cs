...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ChannelMembershipRequest")]
    public partial class ChannelMembershipRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChannelMembershipRequest" /> class.
        /// </summary>
        /// <param name="accountId">accountId.</param>
        public ChannelMembershipRequest(string accountId = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChannelMembershipRequest {\n");
