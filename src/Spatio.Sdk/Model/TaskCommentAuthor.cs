...
namespace Spatio.Sdk.Model
{
    ...
    /// TaskCommentAuthor
    /// </summary>
    [DataContract(Name = "TaskCommentAuthor")]
    public partial class TaskCommentAuthor : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TaskCommentAuthor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TaskCommentAuthor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TaskCommentAuthor" /> class.
        /// </summary>
        ...
        public TaskCommentAuthor(string id = default, string name = default, string email = default, string profilePhoto = default)
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for TaskCommentAuthor and cannot be null");
            }
            this.Id = id;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for TaskCommentAuthor and cannot be null");
            }
            this.Name = name;
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new ArgumentNullException("email is a required property for TaskCommentAuthor and cannot be null");
            }
            this.Email = email;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TaskCommentAuthor {\n");
