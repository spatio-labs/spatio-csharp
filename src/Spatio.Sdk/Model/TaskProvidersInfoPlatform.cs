...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TaskProvidersInfo_platform")]
    public partial class TaskProvidersInfoPlatform : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TaskProvidersInfoPlatform" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TaskProvidersInfoPlatform() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TaskProvidersInfoPlatform" /> class.
        /// </summary>
        /// <param name="name">name (required).</param>
        /// <param name="description">description (required).</param>
        public TaskProvidersInfoPlatform(string name = default, string description = default)
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for TaskProvidersInfoPlatform and cannot be null");
            }
            this.Name = name;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for TaskProvidersInfoPlatform and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TaskProvidersInfoPlatform {\n");
