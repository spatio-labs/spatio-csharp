...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SearchEmailsResponse")]
    public partial class SearchEmailsResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchEmailsResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SearchEmailsResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchEmailsResponse" /> class.
        /// </summary>
        /// <param name="emails">&#x60;null&#x60; when there are no results (Go nil-slice serialization). Treat as equivalent to an empty array. .</param>
        /// <param name="total">total (required).</param>
        /// <param name="nextPageToken">nextPageToken.</param>
        /// <param name="provider">provider (required).</param>
        public SearchEmailsResponse(List<Email> emails = default, int total = default, string nextPageToken = default, string provider = default)
        {
            this.Total = total;
            // to ensure "provider" is required (not null)
            if (provider == null)
            {
                throw new ArgumentNullException("provider is a required property for SearchEmailsResponse and cannot be null");
            }
        ...
        /// </summary>
        /// <value>&#x60;null&#x60; when there are no results (Go nil-slice serialization). Treat as equivalent to an empty array. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SearchEmailsResponse {\n");
