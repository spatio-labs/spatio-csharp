...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateOrganizationInvitationRequest")]
    public partial class CreateOrganizationInvitationRequest : IValidatableObject
    {
        /// <summary>
        /// Defines Role
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateOrganizationInvitationRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateOrganizationInvitationRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateOrganizationInvitationRequest" /> class.
        /// </summary>
        /// <param name="email">email (required).</param>
        /// <param name="role">role (required).</param>
        /// <param name="workspaceId">Optional — the invitee will also be added to this workspace on accept. Defaults to the org&#39;s default workspace. .</param>
        public CreateOrganizationInvitationRequest(string email = default, RoleEnum role = default, string workspaceId = default)
        {
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new ArgumentNullException("email is a required property for CreateOrganizationInvitationRequest and cannot be null");
            }
            this.Email = email;
            this.Role = role;
        ...
        /// </summary>
        /// <value>Optional — the invitee will also be added to this workspace on accept. Defaults to the org&#39;s default workspace. </value>
