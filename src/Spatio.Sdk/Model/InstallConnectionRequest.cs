...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InstallConnectionRequest")]
    public partial class InstallConnectionRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InstallConnectionRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InstallConnectionRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InstallConnectionRequest" /> class.
        /// </summary>
        ...
        public InstallConnectionRequest(string connectionId = default, string accountId = default, Dictionary<string, Object> metadata = default)
        {
            // to ensure "connectionId" is required (not null)
            if (connectionId == null)
            {
                throw new ArgumentNullException("connectionId is a required property for InstallConnectionRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InstallConnectionRequest {\n");
