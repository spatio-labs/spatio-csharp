...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WorkspaceListResponse")]
    public partial class WorkspaceListResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkspaceListResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WorkspaceListResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkspaceListResponse" /> class.
        /// </summary>
        /// <param name="workspaces">workspaces (required).</param>
        /// <param name="total">total.</param>
        public WorkspaceListResponse(List<Workspace> workspaces = default, int total = default)
        {
            // to ensure "workspaces" is required (not null)
            if (workspaces == null)
            {
                throw new ArgumentNullException("workspaces is a required property for WorkspaceListResponse and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WorkspaceListResponse {\n");
