...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ExecuteActionRequest")]
    public partial class ExecuteActionRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExecuteActionRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ExecuteActionRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ExecuteActionRequest" /> class.
        /// </summary>
        ...
        public ExecuteActionRequest(string actionId = default, Dictionary<string, Object> varParams = default, string accountId = default)
        {
            // to ensure "actionId" is required (not null)
            if (actionId == null)
            {
                throw new ArgumentNullException("actionId is a required property for ExecuteActionRequest and cannot be null");
            }
