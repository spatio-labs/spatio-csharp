...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RoutineRunProgressRequest")]
    public partial class RoutineRunProgressRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RoutineRunProgressRequest" /> class.
        /// </summary>
        /// <param name="progress">progress.</param>
        /// <param name="metadata">metadata.</param>
        public RoutineRunProgressRequest(int progress = default, Dictionary<string, Object> metadata = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RoutineRunProgressRequest {\n");
