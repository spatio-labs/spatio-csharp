...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CoreActionListResponse")]
    public partial class CoreActionListResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreActionListResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoreActionListResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreActionListResponse" /> class.
        /// </summary>
        /// <param name="actions">actions (required).</param>
        /// <param name="total">total.</param>
        public CoreActionListResponse(List<CoreAction> actions = default, int total = default)
        {
            // to ensure "actions" is required (not null)
            if (actions == null)
            {
                throw new ArgumentNullException("actions is a required property for CoreActionListResponse and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CoreActionListResponse {\n");
