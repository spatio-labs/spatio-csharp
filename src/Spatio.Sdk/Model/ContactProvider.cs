...
namespace Spatio.Sdk.Model
{
    ...
    /// ContactProvider
    /// </summary>
    [DataContract(Name = "ContactProvider")]
    public partial class ContactProvider : IValidatableObject
    {
        /// <summary>
        ...
        public ContactProvider(string id = default, string name = default, string displayName = default, string description = default, bool isSystem = default)
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for ContactProvider and cannot be null");
            }
            this.Id = id;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for ContactProvider and cannot be null");
            }
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContactProvider {\n");
