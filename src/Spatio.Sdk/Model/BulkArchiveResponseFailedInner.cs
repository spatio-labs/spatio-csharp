...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BulkArchiveResponse_failed_inner")]
    public partial class BulkArchiveResponseFailedInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkArchiveResponseFailedInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BulkArchiveResponseFailedInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkArchiveResponseFailedInner" /> class.
        /// </summary>
        /// <param name="messageId">messageId (required).</param>
        /// <param name="error">error (required).</param>
        public BulkArchiveResponseFailedInner(string messageId = default, string error = default)
        {
            // to ensure "messageId" is required (not null)
            if (messageId == null)
            {
                throw new ArgumentNullException("messageId is a required property for BulkArchiveResponseFailedInner and cannot be null");
            }
            this.MessageId = messageId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for BulkArchiveResponseFailedInner and cannot be null");
            }
            this.Error = error;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BulkArchiveResponseFailedInner {\n");
