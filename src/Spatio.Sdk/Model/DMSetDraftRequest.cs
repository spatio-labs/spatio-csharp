...
namespace Spatio.Sdk.Model
{
    ...
    /// DMSetDraftRequest
    /// </summary>
    [DataContract(Name = "DMSetDraftRequest")]
    public partial class DMSetDraftRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DMSetDraftRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DMSetDraftRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DMSetDraftRequest" /> class.
        /// </summary>
        /// <param name="text">text (required).</param>
        /// <param name="accountId">accountId.</param>
        public DMSetDraftRequest(string text = default, string accountId = default)
        {
            // to ensure "text" is required (not null)
            if (text == null)
            {
                throw new ArgumentNullException("text is a required property for DMSetDraftRequest and cannot be null");
            }
            this.Text = text;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DMSetDraftRequest {\n");
