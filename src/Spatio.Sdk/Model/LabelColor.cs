...
namespace Spatio.Sdk.Model
{
    ...
    /// LabelColor
    /// </summary>
    [DataContract(Name = "LabelColor")]
    public partial class LabelColor : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LabelColor" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="LabelColor" /> class.
        /// </summary>
        /// <param name="textColor">textColor (required).</param>
        /// <param name="backgroundColor">backgroundColor (required).</param>
        public LabelColor(string textColor = default, string backgroundColor = default)
        {
            // to ensure "textColor" is required (not null)
            if (textColor == null)
            {
                throw new ArgumentNullException("textColor is a required property for LabelColor and cannot be null");
            }
            this.TextColor = textColor;
            // to ensure "backgroundColor" is required (not null)
            if (backgroundColor == null)
            {
                throw new ArgumentNullException("backgroundColor is a required property for LabelColor and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "textColor", IsRequired = true, EmitDefaultValue = true)]
        public string TextColor { get; set; }

        /// <summary>
        /// Gets or Sets BackgroundColor
        /// </summary>
        [DataMember(Name = "backgroundColor", IsRequired = true, EmitDefaultValue = true)]
