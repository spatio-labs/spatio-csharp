...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateContactCategoryRequest")]
    public partial class CreateContactCategoryRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateContactCategoryRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateContactCategoryRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateContactCategoryRequest" /> class.
        /// </summary>
        ...
        public CreateContactCategoryRequest(string name = default, string color = default, string description = default)
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CreateContactCategoryRequest and cannot be null");
            }
            this.Name = name;
            this.Color = color;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateContactCategoryRequest {\n");
