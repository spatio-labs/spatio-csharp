...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateSlideElementRequest")]
    public partial class CreateSlideElementRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSlideElementRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateSlideElementRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSlideElementRequest" /> class.
        /// </summary>
        ...
        public CreateSlideElementRequest(string elementType = default, Dictionary<string, Object> content = default, double x = default, double y = default, double width = default, double height = default, double rotation = default, int zIndex = default)
        {
            // to ensure "elementType" is required (not null)
            if (elementType == null)
            {
                throw new ArgumentNullException("elementType is a required property for CreateSlideElementRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateSlideElementRequest {\n");
