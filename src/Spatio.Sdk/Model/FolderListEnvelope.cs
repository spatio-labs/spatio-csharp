...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FolderListEnvelope")]
    public partial class FolderListEnvelope : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FolderListEnvelope" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FolderListEnvelope() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FolderListEnvelope" /> class.
        /// </summary>
        /// <param name="items">items (required).</param>
        /// <param name="accounts">accounts (required).</param>
        public FolderListEnvelope(List<Folder> items = default, List<AccountStatus> accounts = default)
        {
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new ArgumentNullException("items is a required property for FolderListEnvelope and cannot be null");
            }
            this.Items = items;
            // to ensure "accounts" is required (not null)
            if (accounts == null)
            {
                throw new ArgumentNullException("accounts is a required property for FolderListEnvelope and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FolderListEnvelope {\n");
