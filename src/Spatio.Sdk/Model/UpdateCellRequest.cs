...
namespace Spatio.Sdk.Model
{
    ...
    /// UpdateCellRequest
    /// </summary>
    [DataContract(Name = "UpdateCellRequest")]
    public partial class UpdateCellRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateCellRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateCellRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateCellRequest" /> class.
        /// </summary>
        /// <param name="value">New cell value (any JSON type). (required).</param>
        public UpdateCellRequest(Object value = default)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for UpdateCellRequest and cannot be null");
            }
            this.Value = value;
        }
        ...
        /// </summary>
        /// <value>New cell value (any JSON type).</value>
