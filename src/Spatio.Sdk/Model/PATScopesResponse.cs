...
namespace Spatio.Sdk.Model
{
    ...
    /// PATScopesResponse
    /// </summary>
    [DataContract(Name = "PATScopesResponse")]
    public partial class PATScopesResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PATScopesResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PATScopesResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PATScopesResponse" /> class.
        /// </summary>
        /// <param name="scopes">scopes (required).</param>
        public PATScopesResponse(List<string> scopes = default)
        {
            // to ensure "scopes" is required (not null)
            if (scopes == null)
            {
                throw new ArgumentNullException("scopes is a required property for PATScopesResponse and cannot be null");
            }
            this.Scopes = scopes;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PATScopesResponse {\n");
