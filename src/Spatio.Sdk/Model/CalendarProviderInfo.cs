...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CalendarProviderInfo")]
    public partial class CalendarProviderInfo : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CalendarProviderInfo" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CalendarProviderInfo() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CalendarProviderInfo" /> class.
        /// </summary>
        /// <param name="id">Stable provider id (e.g. &#x60;google-calendar&#x60;, &#x60;native-calendar&#x60;). (required).</param>
        /// <param name="name">name (required).</param>
        /// <param name="displayName">displayName.</param>
        /// <param name="description">description.</param>
        /// <param name="isSystem">&#x60;true&#x60; for built-in providers (the native calendar)..</param>
        public CalendarProviderInfo(string id = default, string name = default, string displayName = default, string description = default, bool isSystem = default)
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for CalendarProviderInfo and cannot be null");
            }
            this.Id = id;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CalendarProviderInfo and cannot be null");
            }
            this.Name = name;
        ...
        /// </summary>
        /// <value>Stable provider id (e.g. &#x60;google-calendar&#x60;, &#x60;native-calendar&#x60;).</value>
        ...
        /// </summary>
        /// <value>&#x60;true&#x60; for built-in providers (the native calendar).</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CalendarProviderInfo {\n");
