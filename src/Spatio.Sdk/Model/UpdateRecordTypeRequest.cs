...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateRecordTypeRequest")]
    public partial class UpdateRecordTypeRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateRecordTypeRequest" /> class.
        /// </summary>
        ...
        public UpdateRecordTypeRequest(string slug = default, string name = default, string namePlural = default, string icon = default, List<Dictionary<string, Object>> attributeSchema = default)
        {
            this.Slug = slug;
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateRecordTypeRequest {\n");
