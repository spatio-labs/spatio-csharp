...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateAgentMessageRequest")]
    public partial class CreateAgentMessageRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAgentMessageRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateAgentMessageRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAgentMessageRequest" /> class.
        /// </summary>
        ...
        public CreateAgentMessageRequest(string role = default, string content = default, Dictionary<string, Object> metadata = default)
        {
            // to ensure "role" is required (not null)
            if (role == null)
            {
                throw new ArgumentNullException("role is a required property for CreateAgentMessageRequest and cannot be null");
            }
            this.Role = role;
            // to ensure "content" is required (not null)
            if (content == null)
            {
                throw new ArgumentNullException("content is a required property for CreateAgentMessageRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateAgentMessageRequest {\n");
