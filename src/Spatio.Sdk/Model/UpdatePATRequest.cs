...
namespace Spatio.Sdk.Model
{
    ...
    /// UpdatePATRequest
    /// </summary>
    [DataContract(Name = "UpdatePATRequest")]
    public partial class UpdatePATRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdatePATRequest" /> class.
        /// </summary>
        /// <param name="name">name.</param>
        /// <param name="description">description.</param>
        public UpdatePATRequest(string name = default, string description = default)
        {
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdatePATRequest {\n");
