...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AgentConversationListResponse")]
    public partial class AgentConversationListResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AgentConversationListResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AgentConversationListResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AgentConversationListResponse" /> class.
        /// </summary>
        /// <param name="conversations">conversations (required).</param>
        /// <param name="total">total.</param>
        public AgentConversationListResponse(List<AgentConversation> conversations = default, int total = default)
        {
            // to ensure "conversations" is required (not null)
            if (conversations == null)
            {
                throw new ArgumentNullException("conversations is a required property for AgentConversationListResponse and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AgentConversationListResponse {\n");
