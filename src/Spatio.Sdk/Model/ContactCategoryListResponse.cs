...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ContactCategoryListResponse")]
    public partial class ContactCategoryListResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactCategoryListResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ContactCategoryListResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactCategoryListResponse" /> class.
        /// </summary>
        /// <param name="categories">categories (required).</param>
        public ContactCategoryListResponse(List<ContactCategory> categories = default)
        {
            // to ensure "categories" is required (not null)
            if (categories == null)
            {
                throw new ArgumentNullException("categories is a required property for ContactCategoryListResponse and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContactCategoryListResponse {\n");
