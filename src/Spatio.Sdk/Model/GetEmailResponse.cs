...
namespace Spatio.Sdk.Model
{
    ...
    /// GetEmailResponse
    /// </summary>
    [DataContract(Name = "GetEmailResponse")]
    public partial class GetEmailResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetEmailResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetEmailResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetEmailResponse" /> class.
        /// </summary>
        /// <param name="email">email (required).</param>
        /// <param name="provider">provider (required).</param>
        public GetEmailResponse(Email email = default, string provider = default)
        {
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new ArgumentNullException("email is a required property for GetEmailResponse and cannot be null");
            }
            this.Email = email;
            // to ensure "provider" is required (not null)
            if (provider == null)
            {
                throw new ArgumentNullException("provider is a required property for GetEmailResponse and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetEmailResponse {\n");
