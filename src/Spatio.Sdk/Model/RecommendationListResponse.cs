...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RecommendationListResponse")]
    public partial class RecommendationListResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RecommendationListResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RecommendationListResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RecommendationListResponse" /> class.
        /// </summary>
        /// <param name="items">items (required).</param>
        public RecommendationListResponse(List<Recommendation> items = default)
        {
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new ArgumentNullException("items is a required property for RecommendationListResponse and cannot be null");
            }
            this.Items = items;
        }
        ...
        public List<Recommendation> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RecommendationListResponse {\n");
