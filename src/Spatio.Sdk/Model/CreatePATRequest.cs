...
namespace Spatio.Sdk.Model
{
    ...
    /// CreatePATRequest
    /// </summary>
    [DataContract(Name = "CreatePATRequest")]
    public partial class CreatePATRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreatePATRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreatePATRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreatePATRequest" /> class.
        /// </summary>
        ...
        public CreatePATRequest(string name = default, string description = default, List<string> scopes = default, string workspaceId = default, DateTime expiresAt = default)
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CreatePATRequest and cannot be null");
            }
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreatePATRequest {\n");
