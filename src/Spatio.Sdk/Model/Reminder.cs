...
namespace Spatio.Sdk.Model
{
    ...
    public partial class Reminder : IValidatableObject
    {
        ...
        /// <param name="minutes">Trigger time in minutes before the event start. (required).</param>
        public Reminder(ReminderMethod method = default, int minutes = default)
        {
            this.Method = method;
        ...
        /// </summary>
        /// <value>Trigger time in minutes before the event start.</value>
