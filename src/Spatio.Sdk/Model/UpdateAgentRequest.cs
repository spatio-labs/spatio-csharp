...
namespace Spatio.Sdk.Model
{
    ...
    /// UpdateAgentRequest
    /// </summary>
    [DataContract(Name = "UpdateAgentRequest")]
    public partial class UpdateAgentRequest : IValidatableObject
    {
        /// <summary>
        ...
        public UpdateAgentRequest(string name = default, string description = default, string systemPrompt = default, List<string> tools = default, string icon = default, string color = default, Dictionary<string, Object> metadata = default)
        {
            this.Name = name;
