...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RoutineRunListResponse")]
    public partial class RoutineRunListResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RoutineRunListResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RoutineRunListResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RoutineRunListResponse" /> class.
        /// </summary>
        /// <param name="items">items (required).</param>
        public RoutineRunListResponse(List<RoutineRun> items = default)
        {
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new ArgumentNullException("items is a required property for RoutineRunListResponse and cannot be null");
            }
            this.Items = items;
        }
        ...
        public List<RoutineRun> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RoutineRunListResponse {\n");
