...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OrganizationListResponse")]
    public partial class OrganizationListResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrganizationListResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OrganizationListResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OrganizationListResponse" /> class.
        /// </summary>
        /// <param name="organizations">organizations (required).</param>
        public OrganizationListResponse(List<Organization> organizations = default)
        {
            // to ensure "organizations" is required (not null)
            if (organizations == null)
            {
                throw new ArgumentNullException("organizations is a required property for OrganizationListResponse and cannot be null");
            }
