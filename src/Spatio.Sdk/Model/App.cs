...
namespace Spatio.Sdk.Model
{
    ...
    public partial class App : IValidatableObject
    {
        ...
        public App(string id = default, string name = default, string description = default, string projectPath = default, string icon = default, string color = default, DateTime createdAt = default, DateTime updatedAt = default)
        {
