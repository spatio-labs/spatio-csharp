...
namespace Spatio.Sdk.Model
{
    ...
    /// BulkArchiveRequest
    /// </summary>
    [DataContract(Name = "BulkArchiveRequest")]
    public partial class BulkArchiveRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkArchiveRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BulkArchiveRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkArchiveRequest" /> class.
        /// </summary>
        /// <param name="accountId">accountId.</param>
        /// <param name="messageIds">messageIds (required).</param>
        public BulkArchiveRequest(string accountId = default, List<string> messageIds = default)
        {
            // to ensure "messageIds" is required (not null)
            if (messageIds == null)
            {
                throw new ArgumentNullException("messageIds is a required property for BulkArchiveRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BulkArchiveRequest {\n");
