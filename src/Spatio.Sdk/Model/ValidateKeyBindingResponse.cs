...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ValidateKeyBindingResponse")]
    public partial class ValidateKeyBindingResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ValidateKeyBindingResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ValidateKeyBindingResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ValidateKeyBindingResponse" /> class.
        /// </summary>
        /// <param name="valid">valid (required).</param>
        /// <param name="conflicts">conflicts.</param>
        public ValidateKeyBindingResponse(bool valid = default, List<Dictionary<string, Object>> conflicts = default)
        {
            this.Valid = valid;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ValidateKeyBindingResponse {\n");
