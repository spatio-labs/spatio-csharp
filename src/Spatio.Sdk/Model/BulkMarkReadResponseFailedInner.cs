...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BulkMarkReadResponse_failed_inner")]
    public partial class BulkMarkReadResponseFailedInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkMarkReadResponseFailedInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BulkMarkReadResponseFailedInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkMarkReadResponseFailedInner" /> class.
        /// </summary>
        /// <param name="id">id (required).</param>
        /// <param name="error">error (required).</param>
        public BulkMarkReadResponseFailedInner(string id = default, string error = default)
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for BulkMarkReadResponseFailedInner and cannot be null");
            }
            this.Id = id;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for BulkMarkReadResponseFailedInner and cannot be null");
            }
            this.Error = error;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BulkMarkReadResponseFailedInner {\n");
