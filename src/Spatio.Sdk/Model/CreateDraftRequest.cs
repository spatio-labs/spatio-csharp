...
namespace Spatio.Sdk.Model
{
    ...
    /// CreateDraftRequest
    /// </summary>
    [DataContract(Name = "CreateDraftRequest")]
    public partial class CreateDraftRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateDraftRequest" /> class.
        /// </summary>
        ...
        /// <param name="threadId">Provider thread id — set when this draft is a reply, so the sent message lands inside the parent thread. .</param>
        /// <param name="inReplyTo">inReplyTo.</param>
        /// <param name="references">references.</param>
        public CreateDraftRequest(string accountId = default, List<string> to = default, List<string> cc = default, List<string> bcc = default, string subject = default, string body = default, bool html = default, List<AttachmentInput> attachments = default, string threadId = default, string inReplyTo = default, List<string> references = default)
        {
        ...
        /// </summary>
        /// <value>Provider thread id — set when this draft is a reply, so the sent message lands inside the parent thread. </value>
