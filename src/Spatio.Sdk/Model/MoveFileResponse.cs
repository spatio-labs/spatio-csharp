...
namespace Spatio.Sdk.Model
{
    ...
    /// MoveFileResponse
    /// </summary>
    [DataContract(Name = "MoveFileResponse")]
    public partial class MoveFileResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MoveFileResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MoveFileResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MoveFileResponse" /> class.
        /// </summary>
        /// <param name="message">message (required).</param>
        public MoveFileResponse(string message = default)
        {
            // to ensure "message" is required (not null)
            if (message == null)
            {
                throw new ArgumentNullException("message is a required property for MoveFileResponse and cannot be null");
            }
