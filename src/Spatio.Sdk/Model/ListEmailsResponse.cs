...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListEmailsResponse")]
    public partial class ListEmailsResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListEmailsResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListEmailsResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListEmailsResponse" /> class.
        /// </summary>
        ...
        public ListEmailsResponse(List<Email> emails = default, int total = default, string nextPageToken = default, string provider = default)
        {
            this.Total = total;
            // to ensure "provider" is required (not null)
            if (provider == null)
            {
                throw new ArgumentNullException("provider is a required property for ListEmailsResponse and cannot be null");
            }
