...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateKeyBindingRequest")]
    public partial class UpdateKeyBindingRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateKeyBindingRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateKeyBindingRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateKeyBindingRequest" /> class.
        /// </summary>
        /// <param name="key">key (required).</param>
        /// <param name="modifiers">modifiers.</param>
        public UpdateKeyBindingRequest(string key = default, List<string> modifiers = default)
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for UpdateKeyBindingRequest and cannot be null");
            }
            this.Key = key;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateKeyBindingRequest {\n");
