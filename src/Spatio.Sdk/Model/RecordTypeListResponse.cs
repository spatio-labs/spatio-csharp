...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RecordTypeListResponse")]
    public partial class RecordTypeListResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RecordTypeListResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RecordTypeListResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RecordTypeListResponse" /> class.
        /// </summary>
        /// <param name="recordTypes">recordTypes (required).</param>
        public RecordTypeListResponse(List<RecordType> recordTypes = default)
        {
            // to ensure "recordTypes" is required (not null)
            if (recordTypes == null)
            {
                throw new ArgumentNullException("recordTypes is a required property for RecordTypeListResponse and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "record_types", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RecordTypeListResponse {\n");
