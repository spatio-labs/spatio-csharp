...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NoteListEnvelope")]
    public partial class NoteListEnvelope : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NoteListEnvelope" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NoteListEnvelope() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NoteListEnvelope" /> class.
        /// </summary>
        /// <param name="items">items (required).</param>
        /// <param name="accounts">accounts (required).</param>
        public NoteListEnvelope(List<Note> items = default, List<AccountStatus> accounts = default)
        {
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new ArgumentNullException("items is a required property for NoteListEnvelope and cannot be null");
            }
            this.Items = items;
            // to ensure "accounts" is required (not null)
            if (accounts == null)
            {
                throw new ArgumentNullException("accounts is a required property for NoteListEnvelope and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NoteListEnvelope {\n");
