...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ContactProviderListResponse")]
    public partial class ContactProviderListResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactProviderListResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ContactProviderListResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactProviderListResponse" /> class.
        /// </summary>
        /// <param name="providers">providers (required).</param>
        public ContactProviderListResponse(List<ContactProvider> providers = default)
        {
            // to ensure "providers" is required (not null)
            if (providers == null)
            {
                throw new ArgumentNullException("providers is a required property for ContactProviderListResponse and cannot be null");
            }
        ...
        public List<ContactProvider> Providers { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContactProviderListResponse {\n");
