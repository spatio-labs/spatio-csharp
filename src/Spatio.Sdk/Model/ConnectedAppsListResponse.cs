...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConnectedAppsListResponse")]
    public partial class ConnectedAppsListResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConnectedAppsListResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ConnectedAppsListResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConnectedAppsListResponse" /> class.
        /// </summary>
        /// <param name="items">items (required).</param>
        public ConnectedAppsListResponse(List<ConnectedAppItem> items = default)
        {
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new ArgumentNullException("items is a required property for ConnectedAppsListResponse and cannot be null");
            }
            this.Items = items;
        }
        ...
        public List<ConnectedAppItem> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConnectedAppsListResponse {\n");
