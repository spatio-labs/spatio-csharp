...
namespace Spatio.Sdk.Model
{
    ...
    /// MoveEmailsRequest
    /// </summary>
    [DataContract(Name = "MoveEmailsRequest")]
    public partial class MoveEmailsRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MoveEmailsRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MoveEmailsRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MoveEmailsRequest" /> class.
        /// </summary>
        /// <param name="messageIds">messageIds (required).</param>
        public MoveEmailsRequest(List<string> messageIds = default)
        {
            // to ensure "messageIds" is required (not null)
            if (messageIds == null)
            {
                throw new ArgumentNullException("messageIds is a required property for MoveEmailsRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MoveEmailsRequest {\n");
