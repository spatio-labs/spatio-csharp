...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListChatUsersResponse")]
    public partial class ListChatUsersResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListChatUsersResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListChatUsersResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListChatUsersResponse" /> class.
        /// </summary>
        ...
        public ListChatUsersResponse(List<ChatUser> users = default, int total = default, string nextCursor = default, string provider = default)
        {
            this.Total = total;
            // to ensure "provider" is required (not null)
            if (provider == null)
            {
                throw new ArgumentNullException("provider is a required property for ListChatUsersResponse and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListChatUsersResponse {\n");
