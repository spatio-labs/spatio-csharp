...
namespace Spatio.Sdk.Model
{
    ...
    /// ChatActionsList
    /// </summary>
    [DataContract(Name = "ChatActionsList")]
    public partial class ChatActionsList : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChatActionsList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ChatActionsList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ChatActionsList" /> class.
        /// </summary>
        /// <param name="actions">actions (required).</param>
        public ChatActionsList(List<ChatActionDefinition> actions = default)
        {
            // to ensure "actions" is required (not null)
            if (actions == null)
            {
                throw new ArgumentNullException("actions is a required property for ChatActionsList and cannot be null");
            }
        ...
        public List<ChatActionDefinition> Actions { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChatActionsList {\n");
