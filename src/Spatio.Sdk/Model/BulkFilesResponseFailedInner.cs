...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BulkFilesResponse_failed_inner")]
    public partial class BulkFilesResponseFailedInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkFilesResponseFailedInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BulkFilesResponseFailedInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkFilesResponseFailedInner" /> class.
        /// </summary>
        /// <param name="fileId">fileId (required).</param>
        /// <param name="error">error (required).</param>
        public BulkFilesResponseFailedInner(string fileId = default, string error = default)
        {
            // to ensure "fileId" is required (not null)
            if (fileId == null)
            {
                throw new ArgumentNullException("fileId is a required property for BulkFilesResponseFailedInner and cannot be null");
            }
            this.FileId = fileId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for BulkFilesResponseFailedInner and cannot be null");
            }
            this.Error = error;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BulkFilesResponseFailedInner {\n");
