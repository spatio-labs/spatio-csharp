...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateWorkspaceRequest")]
    public partial class UpdateWorkspaceRequest : IValidatableObject
    {
        ...
        public UpdateWorkspaceRequest(string name = default, string description = default, string logoUrl = default, Dictionary<string, Object> settings = default)
        {
            this.Name = name;
