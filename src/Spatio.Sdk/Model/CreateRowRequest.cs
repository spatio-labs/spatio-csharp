...
namespace Spatio.Sdk.Model
{
    ...
    /// CreateRowRequest
    /// </summary>
    [DataContract(Name = "CreateRowRequest")]
    public partial class CreateRowRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateRowRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateRowRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateRowRequest" /> class.
        /// </summary>
        /// <param name="index">Optional zero-based insert position. Omit to append at the end. .</param>
        /// <param name="cells">cells (required).</param>
        public CreateRowRequest(int index = default, Dictionary<string, Object> cells = default)
        {
            // to ensure "cells" is required (not null)
            if (cells == null)
            {
                throw new ArgumentNullException("cells is a required property for CreateRowRequest and cannot be null");
            }
            this.Cells = cells;
            this.Index = index;
        }
        ...
        /// </summary>
        /// <value>Optional zero-based insert position. Omit to append at the end. </value>
