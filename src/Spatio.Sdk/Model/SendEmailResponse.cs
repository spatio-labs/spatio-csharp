...
namespace Spatio.Sdk.Model
{
    ...
    public partial class SendEmailResponse : IValidatableObject
    {
        ...
        public SendEmailResponse(bool success = default, string messageId = default, string threadId = default, string provider = default, string error = default)
        {
            this.Success = success;
            // to ensure "messageId" is required (not null)
            if (messageId == null)
            {
                throw new ArgumentNullException("messageId is a required property for SendEmailResponse and cannot be null");
            }
            this.MessageId = messageId;
            // to ensure "provider" is required (not null)
            if (provider == null)
            {
                throw new ArgumentNullException("provider is a required property for SendEmailResponse and cannot be null");
            }
