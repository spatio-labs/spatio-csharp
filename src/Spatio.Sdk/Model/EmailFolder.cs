...
namespace Spatio.Sdk.Model
{
    ...
    /// EmailFolder
    /// </summary>
    [DataContract(Name = "EmailFolder")]
    public partial class EmailFolder : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailFolder" /> class.
        /// </summary>
        ...
        public EmailFolder(string id = default, string name = default, string accountId = default, Dictionary<string, Object> metadata = default, DateTime createdAt = default)
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for EmailFolder and cannot be null");
            }
            this.Id = id;
            this.Name = name;
