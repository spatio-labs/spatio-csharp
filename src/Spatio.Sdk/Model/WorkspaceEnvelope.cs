...
namespace Spatio.Sdk.Model
{
    ...
    /// WorkspaceEnvelope
    /// </summary>
    [DataContract(Name = "WorkspaceEnvelope")]
    public partial class WorkspaceEnvelope : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkspaceEnvelope" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WorkspaceEnvelope() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkspaceEnvelope" /> class.
        /// </summary>
        /// <param name="workspace">workspace (required).</param>
        public WorkspaceEnvelope(Workspace workspace = default)
        {
            // to ensure "workspace" is required (not null)
            if (workspace == null)
            {
                throw new ArgumentNullException("workspace is a required property for WorkspaceEnvelope and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WorkspaceEnvelope {\n");
