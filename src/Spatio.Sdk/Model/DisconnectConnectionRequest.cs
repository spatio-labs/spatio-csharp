...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DisconnectConnectionRequest")]
    public partial class DisconnectConnectionRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DisconnectConnectionRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DisconnectConnectionRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DisconnectConnectionRequest" /> class.
        /// </summary>
        /// <param name="connectionId">connectionId (required).</param>
        /// <param name="accountId">accountId.</param>
        public DisconnectConnectionRequest(string connectionId = default, string accountId = default)
        {
            // to ensure "connectionId" is required (not null)
            if (connectionId == null)
            {
                throw new ArgumentNullException("connectionId is a required property for DisconnectConnectionRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DisconnectConnectionRequest {\n");
