...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "KeyBindingListResponse")]
    public partial class KeyBindingListResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KeyBindingListResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KeyBindingListResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KeyBindingListResponse" /> class.
        /// </summary>
        /// <param name="bindings">bindings (required).</param>
        public KeyBindingListResponse(List<KeyBinding> bindings = default)
        {
            // to ensure "bindings" is required (not null)
            if (bindings == null)
            {
                throw new ArgumentNullException("bindings is a required property for KeyBindingListResponse and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "bindings", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KeyBindingListResponse {\n");
