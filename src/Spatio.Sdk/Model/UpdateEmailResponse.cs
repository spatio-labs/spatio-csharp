...
namespace Spatio.Sdk.Model
{
    ...
    /// UpdateEmailResponse
    /// </summary>
    [DataContract(Name = "UpdateEmailResponse")]
    public partial class UpdateEmailResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateEmailResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateEmailResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateEmailResponse" /> class.
        /// </summary>
        /// <param name="email">email (required).</param>
        /// <param name="provider">provider (required).</param>
        public UpdateEmailResponse(Email email = default, string provider = default)
        {
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new ArgumentNullException("email is a required property for UpdateEmailResponse and cannot be null");
            }
            this.Email = email;
            // to ensure "provider" is required (not null)
            if (provider == null)
            {
                throw new ArgumentNullException("provider is a required property for UpdateEmailResponse and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateEmailResponse {\n");
