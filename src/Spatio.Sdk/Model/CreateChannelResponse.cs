...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateChannelResponse")]
    public partial class CreateChannelResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateChannelResponse" /> class.
        /// </summary>
        ...
        public CreateChannelResponse(Channel channel = default, string provider = default)
        {
            // to ensure "channel" is required (not null)
            if (channel == null)
            {
                throw new ArgumentNullException("channel is a required property for CreateChannelResponse and cannot be null");
            }
            this.Channel = channel;
            // to ensure "provider" is required (not null)
            if (provider == null)
            {
                throw new ArgumentNullException("provider is a required property for CreateChannelResponse and cannot be null");
            }
