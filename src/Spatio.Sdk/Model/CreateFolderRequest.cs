...
namespace Spatio.Sdk.Model
{
    ...
    public partial class CreateFolderRequest : IValidatableObject
    {
        ...
        public CreateFolderRequest(string accountId = default, string name = default, string parentId = default, string workspaceId = default, string organizationId = default)
        {
