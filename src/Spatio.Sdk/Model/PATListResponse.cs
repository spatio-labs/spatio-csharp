...
namespace Spatio.Sdk.Model
{
    ...
    /// PATListResponse
    /// </summary>
    [DataContract(Name = "PATListResponse")]
    public partial class PATListResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PATListResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PATListResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PATListResponse" /> class.
        /// </summary>
        /// <param name="tokens">tokens (required).</param>
        /// <param name="availableScopes">availableScopes.</param>
        public PATListResponse(List<PersonalAccessToken> tokens = default, List<string> availableScopes = default)
        {
            // to ensure "tokens" is required (not null)
            if (tokens == null)
            {
                throw new ArgumentNullException("tokens is a required property for PATListResponse and cannot be null");
            }
            this.Tokens = tokens;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PATListResponse {\n");
