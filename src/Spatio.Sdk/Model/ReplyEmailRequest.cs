...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ReplyEmailRequest")]
    public partial class ReplyEmailRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReplyEmailRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ReplyEmailRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ReplyEmailRequest" /> class.
        /// </summary>
        ...
        public ReplyEmailRequest(string accountId = default, List<string> to = default, List<string> cc = default, List<string> bcc = default, string body = default, bool html = default, List<AttachmentInput> attachments = default)
        {
            // to ensure "body" is required (not null)
            if (body == null)
            {
                throw new ArgumentNullException("body is a required property for ReplyEmailRequest and cannot be null");
            }
            this.Body = body;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReplyEmailRequest {\n");
