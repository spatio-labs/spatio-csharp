...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BulkDeleteEmailsRequest")]
    public partial class BulkDeleteEmailsRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkDeleteEmailsRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BulkDeleteEmailsRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkDeleteEmailsRequest" /> class.
        /// </summary>
        ...
        public BulkDeleteEmailsRequest(string accountId = default, List<string> messageIds = default, bool permanent = default)
        {
            // to ensure "messageIds" is required (not null)
            if (messageIds == null)
            {
                throw new ArgumentNullException("messageIds is a required property for BulkDeleteEmailsRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BulkDeleteEmailsRequest {\n");
