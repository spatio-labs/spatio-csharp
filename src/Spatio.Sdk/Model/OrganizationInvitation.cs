...
namespace Spatio.Sdk.Model
{
    ...
    public partial class OrganizationInvitation : IValidatableObject
    {
        ...
        /// <param name="token">Opaque invitation token (omitted on list responses)..</param>
        ...
        public OrganizationInvitation(string id = default, string organizationId = default, string email = default, string role = default, string token = default, DateTime? expiresAt = default, DateTime createdAt = default, DateTime? acceptedAt = default, DateTime? revokedAt = default, OrganizationMemberInvitedBy invitedBy = default, StatusEnum? status = default)
        {
            ...
            if (role == null)
            {
                throw new ArgumentNullException("role is a required property for OrganizationInvitation and cannot be null");
            }
            this.Role = role;
        ...
        /// </summary>
        /// <value>Opaque invitation token (omitted on list responses).</value>
