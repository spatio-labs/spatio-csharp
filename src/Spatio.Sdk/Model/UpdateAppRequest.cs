...
namespace Spatio.Sdk.Model
{
    ...
    public partial class UpdateAppRequest : IValidatableObject
    {
        /// <summary>
        ...
        public UpdateAppRequest(string name = default, string description = default, string icon = default, string color = default)
        {
            this.Name = name;
