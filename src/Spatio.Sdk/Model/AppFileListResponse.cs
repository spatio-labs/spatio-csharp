...
namespace Spatio.Sdk.Model
{
    ...
    /// AppFileListResponse
    /// </summary>
    [DataContract(Name = "AppFileListResponse")]
    public partial class AppFileListResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AppFileListResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AppFileListResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AppFileListResponse" /> class.
        /// </summary>
        /// <param name="files">files (required).</param>
        public AppFileListResponse(List<Dictionary<string, Object>> files = default)
        {
            // to ensure "files" is required (not null)
            if (files == null)
            {
                throw new ArgumentNullException("files is a required property for AppFileListResponse and cannot be null");
            }
            this.Files = files;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AppFileListResponse {\n");
