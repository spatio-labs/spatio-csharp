...
namespace Spatio.Sdk.Model
{
    ...
    /// SlideList
    /// </summary>
    [DataContract(Name = "SlideList")]
    public partial class SlideList : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SlideList" /> class.
        /// </summary>
        ...
        public SlideList(List<Slide> slides = default, int total = default)
        {
            // to ensure "slides" is required (not null)
            if (slides == null)
            {
                throw new ArgumentNullException("slides is a required property for SlideList and cannot be null");
            }
            this.Slides = slides;
            this.Total = total;
        }
        ...
        /// Gets or Sets Slides
        /// </summary>
        [DataMember(Name = "slides", IsRequired = true, EmitDefaultValue = true)]
