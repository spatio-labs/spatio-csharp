...
namespace Spatio.Sdk.Model
{
    ...
    /// TaskCommentRequest
    /// </summary>
    [DataContract(Name = "TaskCommentRequest")]
    public partial class TaskCommentRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TaskCommentRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TaskCommentRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TaskCommentRequest" /> class.
        /// </summary>
        /// <param name="content">content (required).</param>
        public TaskCommentRequest(string content = default)
        {
            // to ensure "content" is required (not null)
            if (content == null)
            {
                throw new ArgumentNullException("content is a required property for TaskCommentRequest and cannot be null");
            }
