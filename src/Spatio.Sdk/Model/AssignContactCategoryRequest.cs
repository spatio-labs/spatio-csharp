...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "assignContactCategory_request")]
    public partial class AssignContactCategoryRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AssignContactCategoryRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AssignContactCategoryRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AssignContactCategoryRequest" /> class.
        /// </summary>
        /// <param name="categoryId">categoryId (required).</param>
        public AssignContactCategoryRequest(string categoryId = default)
        {
            // to ensure "categoryId" is required (not null)
            if (categoryId == null)
            {
                throw new ArgumentNullException("categoryId is a required property for AssignContactCategoryRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AssignContactCategoryRequest {\n");
