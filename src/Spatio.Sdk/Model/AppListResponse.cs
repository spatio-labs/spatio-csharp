...
namespace Spatio.Sdk.Model
{
    ...
    /// AppListResponse
    /// </summary>
    [DataContract(Name = "AppListResponse")]
    public partial class AppListResponse : IValidatableObject
    {
        ...
        protected AppListResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AppListResponse" /> class.
        /// </summary>
        /// <param name="apps">apps (required).</param>
        /// <param name="total">total.</param>
        public AppListResponse(List<App> apps = default, int total = default)
        {
            // to ensure "apps" is required (not null)
            if (apps == null)
            {
                throw new ArgumentNullException("apps is a required property for AppListResponse and cannot be null");
            }
            this.Apps = apps;
            this.Total = total;
        }
