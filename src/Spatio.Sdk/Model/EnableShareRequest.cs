...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EnableShareRequest")]
    public partial class EnableShareRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnableShareRequest" /> class.
        /// </summary>
        /// <param name="setPassword">setPassword.</param>
        /// <param name="password">password.</param>
        public EnableShareRequest(bool setPassword = default, string password = default)
        {
        ...
        /// <summary>
        /// Gets or Sets SetPassword
        /// </summary>
        [DataMember(Name = "setPassword", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EnableShareRequest {\n");
            sb.Append("  SetPassword: ").Append(SetPassword).Append("\n");
