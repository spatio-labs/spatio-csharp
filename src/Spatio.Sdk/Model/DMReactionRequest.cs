...
namespace Spatio.Sdk.Model
{
    ...
    /// DMReactionRequest
    /// </summary>
    [DataContract(Name = "DMReactionRequest")]
    public partial class DMReactionRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DMReactionRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DMReactionRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DMReactionRequest" /> class.
        /// </summary>
        /// <param name="emoji">emoji (required).</param>
        /// <param name="accountId">accountId.</param>
        public DMReactionRequest(string emoji = default, string accountId = default)
        {
            // to ensure "emoji" is required (not null)
            if (emoji == null)
            {
                throw new ArgumentNullException("emoji is a required property for DMReactionRequest and cannot be null");
            }
            this.Emoji = emoji;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DMReactionRequest {\n");
