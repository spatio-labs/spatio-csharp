...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AgentMessageListResponse")]
    public partial class AgentMessageListResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AgentMessageListResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AgentMessageListResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AgentMessageListResponse" /> class.
        /// </summary>
        /// <param name="messages">messages (required).</param>
        /// <param name="total">total.</param>
        public AgentMessageListResponse(List<AgentMessage> messages = default, int total = default)
        {
            // to ensure "messages" is required (not null)
            if (messages == null)
            {
                throw new ArgumentNullException("messages is a required property for AgentMessageListResponse and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AgentMessageListResponse {\n");
