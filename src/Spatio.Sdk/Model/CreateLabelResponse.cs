...
namespace Spatio.Sdk.Model
{
    ...
    /// CreateLabelResponse
    /// </summary>
    [DataContract(Name = "CreateLabelResponse")]
    public partial class CreateLabelResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateLabelResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateLabelResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateLabelResponse" /> class.
        /// </summary>
        /// <param name="label">label (required).</param>
        /// <param name="provider">provider (required).</param>
        public CreateLabelResponse(Label label = default, string provider = default)
        {
            // to ensure "label" is required (not null)
            if (label == null)
            {
                throw new ArgumentNullException("label is a required property for CreateLabelResponse and cannot be null");
            }
            this.Label = label;
            // to ensure "provider" is required (not null)
            if (provider == null)
            {
                throw new ArgumentNullException("provider is a required property for CreateLabelResponse and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateLabelResponse {\n");
