...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateWorkspaceInvitationRequest")]
    public partial class CreateWorkspaceInvitationRequest : IValidatableObject
    {
        /// <summary>
        /// Defines Role
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateWorkspaceInvitationRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateWorkspaceInvitationRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateWorkspaceInvitationRequest" /> class.
        /// </summary>
        /// <param name="email">email (required).</param>
        /// <param name="role">role (required).</param>
        public CreateWorkspaceInvitationRequest(string email = default, RoleEnum role = default)
        {
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new ArgumentNullException("email is a required property for CreateWorkspaceInvitationRequest and cannot be null");
            }
            this.Email = email;
            this.Role = role;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateWorkspaceInvitationRequest {\n");
