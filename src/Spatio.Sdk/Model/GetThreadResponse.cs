...
namespace Spatio.Sdk.Model
{
    ...
    /// GetThreadResponse
    /// </summary>
    [DataContract(Name = "GetThreadResponse")]
    public partial class GetThreadResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetThreadResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetThreadResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetThreadResponse" /> class.
        /// </summary>
        /// <param name="thread">thread (required).</param>
        /// <param name="provider">provider (required).</param>
        public GetThreadResponse(SpatioThread thread = default, string provider = default)
        {
            // to ensure "thread" is required (not null)
            if (thread == null)
            {
                throw new ArgumentNullException("thread is a required property for GetThreadResponse and cannot be null");
            }
            this.Thread = thread;
            // to ensure "provider" is required (not null)
            if (provider == null)
            {
                throw new ArgumentNullException("provider is a required property for GetThreadResponse and cannot be null");
            }
        ...
        public SpatioThread Thread { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetThreadResponse {\n");
