...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateMessageMetadataRequest")]
    public partial class UpdateMessageMetadataRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateMessageMetadataRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateMessageMetadataRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateMessageMetadataRequest" /> class.
        /// </summary>
        /// <param name="id">id (required).</param>
        /// <param name="metadata">metadata.</param>
        public UpdateMessageMetadataRequest(string id = default, Dictionary<string, Object> metadata = default)
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for UpdateMessageMetadataRequest and cannot be null");
            }
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateMessageMetadataRequest {\n");
