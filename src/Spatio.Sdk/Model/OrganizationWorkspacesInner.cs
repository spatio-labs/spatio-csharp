...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Organization_workspaces_inner")]
    public partial class OrganizationWorkspacesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrganizationWorkspacesInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OrganizationWorkspacesInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OrganizationWorkspacesInner" /> class.
        /// </summary>
        ...
        public OrganizationWorkspacesInner(string id = default, string name = default, string slug = default)
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for OrganizationWorkspacesInner and cannot be null");
            }
            this.Id = id;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for OrganizationWorkspacesInner and cannot be null");
            }
            this.Name = name;
            // to ensure "slug" is required (not null)
            if (slug == null)
            {
                throw new ArgumentNullException("slug is a required property for OrganizationWorkspacesInner and cannot be null");
            }
            this.Slug = slug;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OrganizationWorkspacesInner {\n");
