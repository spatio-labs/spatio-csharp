...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateEmailFolderRequest")]
    public partial class CreateEmailFolderRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateEmailFolderRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateEmailFolderRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateEmailFolderRequest" /> class.
        /// </summary>
        /// <param name="name">name (required).</param>
        /// <param name="accountId">accountId.</param>
        public CreateEmailFolderRequest(string name = default, string accountId = default)
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CreateEmailFolderRequest and cannot be null");
            }
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateEmailFolderRequest {\n");
