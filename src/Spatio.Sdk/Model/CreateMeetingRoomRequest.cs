...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateMeetingRoomRequest")]
    public partial class CreateMeetingRoomRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateMeetingRoomRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateMeetingRoomRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateMeetingRoomRequest" /> class.
        /// </summary>
        /// <param name="name">name (required).</param>
        /// <param name="workspaceId">workspaceId.</param>
        public CreateMeetingRoomRequest(string name = default, string workspaceId = default)
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CreateMeetingRoomRequest and cannot be null");
            }
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateMeetingRoomRequest {\n");
