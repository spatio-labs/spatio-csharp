...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "federatedSearch_200_response_per_platform_value")]
    public partial class FederatedSearch200ResponsePerPlatformValue : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FederatedSearch200ResponsePerPlatformValue" /> class.
        /// </summary>
        /// <param name="returned">returned.</param>
        /// <param name="total">total.</param>
        public FederatedSearch200ResponsePerPlatformValue(int returned = default, int total = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FederatedSearch200ResponsePerPlatformValue {\n");
