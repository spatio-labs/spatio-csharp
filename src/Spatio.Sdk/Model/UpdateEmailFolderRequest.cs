...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateEmailFolderRequest")]
    public partial class UpdateEmailFolderRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateEmailFolderRequest" /> class.
        /// </summary>
        /// <param name="name">name.</param>
        public UpdateEmailFolderRequest(string name = default)
        {
            this.Name = name;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateEmailFolderRequest {\n");
