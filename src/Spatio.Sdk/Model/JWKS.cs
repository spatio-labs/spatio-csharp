...
namespace Spatio.Sdk.Model
{
    ...
    /// JWKS
    /// </summary>
    [DataContract(Name = "JWKS")]
    public partial class JWKS : IValidatableObject
    {
        /// <summary>
        ...
        public JWKS(List<JWK> keys = default)
        {
            // to ensure "keys" is required (not null)
            if (keys == null)
            {
                throw new ArgumentNullException("keys is a required property for JWKS and cannot be null");
            }
            this.Keys = keys;
        }
