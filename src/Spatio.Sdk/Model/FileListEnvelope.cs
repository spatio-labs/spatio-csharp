...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FileListEnvelope")]
    public partial class FileListEnvelope : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FileListEnvelope" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FileListEnvelope() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FileListEnvelope" /> class.
        /// </summary>
        /// <param name="items">items (required).</param>
        /// <param name="accounts">accounts (required).</param>
        public FileListEnvelope(List<SpatioFile> items = default, List<AccountStatus> accounts = default)
        {
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new ArgumentNullException("items is a required property for FileListEnvelope and cannot be null");
            }
            this.Items = items;
            // to ensure "accounts" is required (not null)
            if (accounts == null)
            {
                throw new ArgumentNullException("accounts is a required property for FileListEnvelope and cannot be null");
            }
        ...
        public List<SpatioFile> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FileListEnvelope {\n");
