...
namespace Spatio.Sdk.Model
{
    ...
    public partial class Record : IValidatableObject
    {
        ...
        public Record(string id = default, string organizationId = default, string recordTypeId = default, string name = default, Dictionary<string, Object> attributes = default, Dictionary<string, Object> metadata = default, DateTime createdAt = default, DateTime updatedAt = default)
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for Record and cannot be null");
            }
            this.Id = id;
        ...
        /// </summary>
        [DataMember(Name = "record_type_id", EmitDefaultValue = false)]
