...
namespace Spatio.Sdk.Model
{
    ...
    /// CreateAgentRequest
    /// </summary>
    [DataContract(Name = "CreateAgentRequest")]
    public partial class CreateAgentRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAgentRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateAgentRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAgentRequest" /> class.
        /// </summary>
        ...
        public CreateAgentRequest(string name = default, string description = default, string systemPrompt = default, List<string> tools = default, string icon = default, string color = default, Dictionary<string, Object> metadata = default)
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CreateAgentRequest and cannot be null");
            }
            this.Name = name;
