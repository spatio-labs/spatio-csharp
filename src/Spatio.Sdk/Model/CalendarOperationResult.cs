...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CalendarOperationResult")]
    public partial class CalendarOperationResult : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CalendarOperationResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CalendarOperationResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CalendarOperationResult" /> class.
        /// </summary>
        /// <param name="success">success (required).</param>
        /// <param name="data">Operation-specific payload. See the operation&#39;s response description for the concrete shape. .</param>
        /// <param name="errors">errors.</param>
        /// <param name="metadata">metadata.</param>
        public CalendarOperationResult(bool success = default, Object data = default, List<CalendarAccountError> errors = default, Dictionary<string, Object> metadata = default)
        {
        ...
        /// </summary>
        /// <value>Operation-specific payload. See the operation&#39;s response description for the concrete shape. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CalendarOperationResult {\n");
