...
namespace Spatio.Sdk.Model
{
    ...
    public partial class ConversationMessage : IValidatableObject
    {
        ...
        /// <param name="role">&#x60;user&#x60;, &#x60;assistant&#x60;, &#x60;system&#x60;, or &#x60;tool&#x60;. (required).</param>
        /// <param name="content">content.</param>
        /// <param name="metadata">metadata.</param>
        /// <param name="createdAt">createdAt.</param>
        public ConversationMessage(string id = default, string conversationId = default, string role = default, string content = default, Dictionary<string, Object> metadata = default, DateTime createdAt = default)
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for ConversationMessage and cannot be null");
            }
            this.Id = id;
            // to ensure "conversationId" is required (not null)
            if (conversationId == null)
            {
                throw new ArgumentNullException("conversationId is a required property for ConversationMessage and cannot be null");
            }
            this.ConversationId = conversationId;
            // to ensure "role" is required (not null)
            if (role == null)
            {
                throw new ArgumentNullException("role is a required property for ConversationMessage and cannot be null");
            }
            this.Role = role;
        ...
        /// </summary>
        /// <value>&#x60;user&#x60;, &#x60;assistant&#x60;, &#x60;system&#x60;, or &#x60;tool&#x60;.</value>
