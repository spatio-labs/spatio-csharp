...
namespace Spatio.Sdk.Model
{
    ...
    /// DraftResponse
    /// </summary>
    [DataContract(Name = "DraftResponse")]
    public partial class DraftResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DraftResponse" /> class.
        /// </summary>
        ...
        public DraftResponse(Draft draft = default, string provider = default)
        {
            // to ensure "draft" is required (not null)
            if (draft == null)
            {
                throw new ArgumentNullException("draft is a required property for DraftResponse and cannot be null");
            }
            this.Draft = draft;
            // to ensure "provider" is required (not null)
            if (provider == null)
            {
                throw new ArgumentNullException("provider is a required property for DraftResponse and cannot be null");
            }
