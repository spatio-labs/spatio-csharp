...
namespace Spatio.Sdk.Model
{
    ...
    public partial class CreateConversationRequest : IValidatableObject
    {
        ...
        public CreateConversationRequest(string title = default, string context = default, string cwd = default, string sessionId = default, Dictionary<string, Object> metadata = default)
        {
            this.Title = title;
