...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DMThreadReplyRequest")]
    public partial class DMThreadReplyRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DMThreadReplyRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DMThreadReplyRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DMThreadReplyRequest" /> class.
        /// </summary>
        /// <param name="content">content (required).</param>
        /// <param name="accountId">accountId.</param>
        public DMThreadReplyRequest(string content = default, string accountId = default)
        {
            // to ensure "content" is required (not null)
            if (content == null)
            {
                throw new ArgumentNullException("content is a required property for DMThreadReplyRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DMThreadReplyRequest {\n");
