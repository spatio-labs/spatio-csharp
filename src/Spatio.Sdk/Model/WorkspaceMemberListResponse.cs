...
namespace Spatio.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WorkspaceMemberListResponse")]
    public partial class WorkspaceMemberListResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkspaceMemberListResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WorkspaceMemberListResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkspaceMemberListResponse" /> class.
        /// </summary>
        /// <param name="members">members (required).</param>
        /// <param name="total">total.</param>
        public WorkspaceMemberListResponse(List<WorkspaceMember> members = default, int total = default)
        {
            // to ensure "members" is required (not null)
            if (members == null)
            {
                throw new ArgumentNullException("members is a required property for WorkspaceMemberListResponse and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WorkspaceMemberListResponse {\n");
