...
namespace Spatio.Sdk.Model
{
    ...
    /// TaskCommentList
    /// </summary>
    [DataContract(Name = "TaskCommentList")]
    public partial class TaskCommentList : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TaskCommentList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TaskCommentList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TaskCommentList" /> class.
        /// </summary>
        /// <param name="comments">comments (required).</param>
        /// <param name="total">total (required).</param>
        public TaskCommentList(List<TaskComment> comments = default, int total = default)
        {
            // to ensure "comments" is required (not null)
            if (comments == null)
            {
                throw new ArgumentNullException("comments is a required property for TaskCommentList and cannot be null");
            }
