...
namespace Spatio.Sdk.Model
{
    ...
    /// ContactListResponse
    /// </summary>
    [DataContract(Name = "ContactListResponse")]
    public partial class ContactListResponse : IValidatableObject
    {
        /// <summary>
        ...
        public ContactListResponse(List<Contact> contacts = default, int totalResults = default, DateTime updatedAt = default)
        {
            // to ensure "contacts" is required (not null)
            if (contacts == null)
            {
                throw new ArgumentNullException("contacts is a required property for ContactListResponse and cannot be null");
            }
